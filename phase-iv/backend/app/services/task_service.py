...
async def create_task(
    ...
    Args:
        ...
        owner_id: User ID who owns this task (Better Auth string UUID)
        owner_email: User email (optional, not used - kept for API compatibility)

    Returns:
        Newly created Task object with auto-generated ID
    """
    # Create task instance (user is managed by Better Auth on frontend)
    task = Task(
