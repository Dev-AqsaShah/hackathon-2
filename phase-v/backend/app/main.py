...
async def lifespan(app: FastAPI):
    ...
    # Create database tables with retry for cold-start DB (e.g. Neon auto-pause)
    ...
    for attempt in range(1, 6):
        try:
            ...
            print(f"DB connection attempt {attempt}/5 failed: {e}")
            if attempt == 5:
                print("WARNING: Could not connect to DB at startup; continuing anyway")
            else:
...
# Phase V routes
from app.api.routes import tags, reminders, notifications
