            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="mt-3 flex items-center gap-3 flex-wrap">
                ...
                >
                  <span
                    className={`
                      ...
                      ${isCompleted ? 'bg-success-400' : isOverdue ? 'bg-red-400' : 'bg-warning-400'}
                    `}
                  />
                ...
                {task.priority && task.priority !== 'none' && (
                  <span className={`inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium border ${priorityConfig[task.priority].classes}`}>
                ...
                {task.tags && task.tags.length > 0 && task.tags.map(tag => (
                  <span
                    key={tag.id}
                    className="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium border border-dark-600/50"
